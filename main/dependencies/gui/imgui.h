...
namespace ImGui
{
    ...
    IMGUI_API bool          TabButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, bool selected);
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilled1(const ImVec2& p_min, const ImVec2& p_max, ImU32 col, float rounding = 0.0f, ImDrawCornerFlags rounding_corners = ImDrawCornerFlags_All);
    ...
    IMGUI_API void  PathRect1(const ImVec2& rect_min, const ImVec2& rect_max, float rounding = 0.0f, ImDrawCornerFlags rounding_corners = ImDrawCornerFlags_All);
